...
deploy_database_model <- function(config, software, software_config){
	...
	db_dimensions <- "area,catchtype,unit,fishing_fleet,gear,schooltype,sex,sizeclass,species,time,source"
	db_variables_and_associated_dimensions <- "catch=schooltype,species,time,area,gear,fishing_fleet,catchtype,unit,source@effort=schooltype,time,area,gear,fishing_fleet,unit,source@catch_at_size=schooltype,species,time,area,gear,fishing_fleet,catchtype,sex,unit,sizeclass,source"
