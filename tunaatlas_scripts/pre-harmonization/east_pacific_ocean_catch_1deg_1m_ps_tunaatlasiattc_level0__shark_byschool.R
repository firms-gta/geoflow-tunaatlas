...
######################################################################
# wps.des: id = pacific_ocean_catch_1deg_1m_ps_tunaatlasiattc_level0__shark_bySchool, title = Harmonize data structure of IATTC PS Shark BySchool catch datasets, abstract = Harmonize the structure of IATTC catch-and-effort datasets: 'PublicPSSharkSetType' (pid of output file = pacific_ocean_catch_1deg_1m_ps_tunaatlasIATTC_level0__shark_bySchool). The only mandatory field is the first one. The metadata must be filled-in only if the dataset will be loaded in the Tuna atlas database. ;
