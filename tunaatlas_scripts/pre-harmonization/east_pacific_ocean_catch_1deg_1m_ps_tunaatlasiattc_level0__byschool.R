...
######################################################################
# wps.des: id = pacific_ocean_catch_1deg_1m_ps_tunaatlasiattc_level0__bySchool, title = Harmonize data structure of IATTC PSSetType catch datasets, abstract = Harmonize the structure of IATTC catch-and-effort datasets: 'PublicPSBillfishSetType' and 'PublicPSTunaSetType' and 'PublicPSSharkSetType' (pid of output file = pacific_ocean_catch_1deg_1m_ps_tunaatlasIATTC_level0__billfish_bySchool or pacific_ocean_catch_1deg_1m_ps_tunaatlasIATTC_level0__shark_bySchool or pacific_ocean_catch_1deg_1m_ps_tunaatlasIATTC_level0__tuna_bySchool). The only mandatory field is the first one. The metadata must be filled-in only if the dataset will be loaded in the Tuna atlas database. ;
