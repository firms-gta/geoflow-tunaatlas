...
######################################################################
# wps.des: id = east_pacific_ocean_catch_1deg_1m_ps_tunaatlasiattc_level0__shark_byFlag, title = Harmonize data structure of IATTC PS Shark ByFlag catch datasets, abstract = Harmonize the structure of IATTC catch-and-effort datasets: 'PublicPSSharkFlag' (pid of output file = east_pacific_ocean_catch_1deg_1m_ps_tunaatlasIATTC_level0__shark_byFlag). The only mandatory field is the first one. The metadata must be filled-in only if the dataset will be loaded in the Tuna atlas database. ;
