			...
			if(options$include_IATTC){
				...
				if(variable == "catch") {
					...
					if (options$iattc_ps_catch_billfish_shark_raise_to_effort){
						...
						df_catch_billfish_flag <- function_raise_catch_to_effort(dataset_file_PSFlag_tuna_effort,dataset_file_PSFlag_billfish_catch,dataset_file_PSFlag_billfish_effort,c("gear","flag","time_start","time_end","geographic_identifier"))
						...
						df_catch_shark_flag <- function_raise_catch_to_effort(dataset_file_PSFlag_tuna_effort,dataset_file_PSFlag_shark_catch,dataset_file_PSFlag_shark_effort,c("gear","flag","time_start","time_end","geographic_identifier"))
					...
					if(options$iattc_ps_raise_flags_to_schooltype){
						...
						# If user decides to not raise flags to type of school, he chooses to use either the data with stratification by flag or the data with stratification by schooltype
