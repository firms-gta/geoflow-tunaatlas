...
if(plotting_type == "plot"){
  ...
  image_to_save <- image
    ...
    image_to_save <-  image + tm_shape(continent)+tm_borders()
  }
...
save_image(title = paste0("Spatial differences between ", titre_1, " and ", titre_2, " dataset"),plott = image_to_save, folder = "Spatialdiffmap", find_and_print = outputonly)
