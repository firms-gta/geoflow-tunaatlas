...
The species concerned by declaration (on a year) of georeferenced captures superior to nominal are : `r paste(unique(georef_sup_to_nom$species), sep = " ; ")`, for a total (by species of)
