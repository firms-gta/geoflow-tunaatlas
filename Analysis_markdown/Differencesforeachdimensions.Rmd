...
if(nrow(compare_dimension_differences_list$Groupped_all_not_disap_or_app_to_dysplay) != 0) {
  qflextable2(compare_dimension_differences_list$Groupped_all_not_disap_or_app_to_dysplay, captionn = "Difference between stratas of the two datasets", grouped_data = c("Dimension", "measurement_unit", "Loss / Gain"), save_folder = "Diffstratas", columns_to_color = c("Difference (in %)"))
} else {
