...
required_packages <- c("dplyr", "knitr", "stringr", "purrr", "readxl", "base", "flextable", "remotes", 
                        ...
                        "stats", "RColorBrewer", "cowplot", "tmap", "RPostgreSQL", "officer", "gdata","tibble", "readtext")
...
fonction_empreinte_spatiale <- function(variable_affichee, initial_dataset = init, final_dataset = final, titre_1 = "Dataset 1", titre_2 = "Dataset 2",shapefile.fix) {
