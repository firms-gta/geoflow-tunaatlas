...
COMMENT ON COLUMN "metadata"."metadataDCMI"."Creator" IS 'customized field includes all contacts as defined by DCMI (http://purl.org/dc/elements/1.1/creator): (Creator,contributor, publisher...)';
