...
ALTER TABLE "metadata" OWNER TO "%db_admin%";
GRANT SELECT ON TABLE "metadata" TO "%db_admin%";
GRANT ALL ON TABLE "metadata" TO "%db_admin%";
...
COMMENT ON COLUMN "metadata"."Contact" IS 'customized field includes all contacts as defined by DCMI (http://purl.org/dc/elements/1.1/creator): (Creator,contributor, publisher...)';
