-- View: public.plot_i1i2_spatial_all_datasets

-- DROP MATERIALIZED VIEW public.plot_i1i2_spatial_all_datasets;

CREATE MATERIALIZED VIEW public.plot_i1i2_spatial_all_datasets
...
ALTER TABLE public.plot_i1i2_spatial_all_datasets
    OWNER TO tunaatlas_u;

GRANT ALL ON TABLE public.plot_i1i2_spatial_all_datasets TO tunaatlas_u;
GRANT SELECT ON TABLE public.plot_i1i2_spatial_all_datasets TO tunaatlas_inv;
