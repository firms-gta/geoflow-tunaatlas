...
CREATE INDEX "metadata_dcmi_geometry_session_geom_idx" ON "metadata"."metadata_dcmi" USING GIST ("geometry");
...
COMMENT ON COLUMN "metadata"."metadata_dcmi"."Creator" IS 'customized field includes all contacts as defined by DCMI (http://purl.org/dc/elements/1.1/creator): (Creator,contributor, publisher...)';
