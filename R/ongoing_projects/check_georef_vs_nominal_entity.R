...
res <- check_georef_vs_nominal_entity(
  "~/firms-gta/geoflow-tunaatlas/jobs/20260320090358/entities/global_catch_ird_level2_1950_2024_decrease_nei",
  steps_to_run = 1:33, use_cache = TRUE
)
qs::qsave(res, "res.qs")

file_path <- "~/firms-gta/geoflow-tunaatlas/jobs/20260320105550/entities/global_catch_ird_level2_1950_2024"

georef_sup_nom_analysis_folder <- file.path(file.path, "georef_sup_nom_analysis/")
