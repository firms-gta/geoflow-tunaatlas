...
log_info("set parameterization and metadata elements according to selected options")
if (action_to_do=="disaggregate"){
  log_info(paste0("Disaggregating data that are defined on quadrants or areas superior to ",resolution,"° quadrant resolution to corresponding ",resolution,"° quadrant by dividing the georef_dataset equally on the overlappings ",resolution,"° x ",resolution,"° quadrants...\n"))
  remove=FALSE 
  ...
  description<-paste0("- Data that were provided at resolutions superior to ",resolution,"° x ",resolution,"° were disaggregated to the corresponding ",resolution,"° x ",resolution,"°quadrants by dividing the catch equally on the overlappings ",resolution,"° x ",resolution,"° quadrants.\n")
    ...
    log_info(sprintf("Removing data that are defined on quadrants or areas superior to [%s]° quadrant resolution ...", resolution))
    remove=TRUE 
...
log_info("BEGIN spatial_curation_downgrade_resolution() function")
...
log_info("END spatial_curation_downgrade_resolution() function")
