...
```{r}
path_to_raw_dataset_catch <- here::here('R/tunaatlas_scripts/pre-harmonization', 'iattc', 'effort', 'data', 'PublicCatchOrigFormatTunaBillfish.csv')
path_to_raw_dataset_effort <- here::here('R/tunaatlas_scripts/pre-harmonization', 'iattc', 'effort', 'data', 'PublicEffortOrigFormatTunaBillfish.csv')
```
