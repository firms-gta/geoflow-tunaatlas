---
title: "Harmonize IATTC PS Shark BySchool Catch Datasets"
output: 
  html_document: 
    code_folding: hide
---
...
```{r}
path_to_raw_dataset <- here::here('R/tunaatlas_scripts/pre-harmonization', 'iattc', 'catch', 'data', 'PublicPSSharkSetType.csv')
```
