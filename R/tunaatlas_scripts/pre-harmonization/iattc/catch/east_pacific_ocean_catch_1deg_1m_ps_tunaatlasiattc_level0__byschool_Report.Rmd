---
title: "Harmonize IATTC PSSetType Catch Datasets by School"
output: 
  html_document: 
    code_folding: hide
---
...
```{r}
path_to_raw_dataset <- here::here('R/tunaatlas_scripts/pre-harmonization', 'iattc', 'catch', 'data', 'PublicPSTunaSetType.csv')
```
