---
title: "Harmonize WCPFC Purse Seine Effort Datasets"
output: 
  html_document: 
    code_folding: hide
---
...
```{r}
path_to_raw_dataset <- here::here('R/tunaatlas_scripts/pre-harmonization', 'wcpfc', 'effort', 'data', 'WCPFC_S_PUBLIC_BY_YR_MON.csv')
```
